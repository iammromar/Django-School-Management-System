...
urlpatterns = [
    ...
    path('search_group', HodViews.search_group, name='search_group'),
    ...
    path('search_session', HodViews.search_session, name='search_session'),
    ...
    path('search_subject', HodViews.search_subject, name='search_subject'),
